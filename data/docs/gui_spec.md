...
| Szín | Kód | Használat |
|------|-----|-----------|
| Narancssárga | `#e0a050` | Kategória fejlécek (aktív fül manőver picker, Státusz picker, Karma hátterek) |
| Manőver dobás picker kategóriák | `#6b9bd1` Általános · `#c98b5e` Belharci · `#8bbf6b` Lovas | Vékony színes bal-sáv + azonos színű szekció-fejléc (`ManoverPicker`, navigáció) |
