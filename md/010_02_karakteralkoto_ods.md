...
Egy `Szilánk` karakter megalkotása nagyságrendekkel meggyorsítható a **Karakteralkotó** használatával, amely egy OpenDocument ods file (az Excel opensource megfelelője). Ennek mindenkori aktuális verziója a [nyitóoldal tetején](start.md#karakteralkot%C3%B3-ods) található meg. 
