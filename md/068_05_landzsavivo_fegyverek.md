...
| ----------------- | :------------: | :-------: | :-------------: | :----------: | :-----: | :--: | :--------: | :--: | :--: | :--: | :------: | :---------: | --------------------------------------------------------------------------------- |
| Alabárd S+V       |    kétkezes    |   `+4`    |      `99`       |    `S+V`     |   `0`   | `0`  |    `3`     | `12` | `28` | `28` |   `9`    | lándzsavívó | Szúró és Vágó módban                                                              |
| Alabárd Z         |    kétkezes    |   `+4`    |      `99`       |     `Z`      |   `5`   | `0`  |    `3`     | `10` | `20` | `24` |   `10`   | lándzsavívó | Zúzó módban. Talán a legjobb a páncélok ellen az Átütéssel.                       |
