...
| ------------ | :------------: | :---: | :----------: | :----: | :--: | :--: | :---: | ---------------: | :------: | :-------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Bola         |    kétkezes    |   -   |      -       |  `0`   | `2`  | `+2` |  `1`  |            `20m` |   `11`   |  hajító   |                                                                                                                                                              |
...
| Dobóháló     |    kétkezes    |   -   |      -       |  `0`   | `2`  | `+0` |  `1`  |            `4m`* |   `11`   |  hajító   | Maximális hatótávolsága: `4+Erő` méterben                                                                                                                    |
...
| Lasszó       |    kétkezes    |   -   |      -       |  `0`   | `0`  | `+0` |  `1`  |            `10m` |   `10`   |  hajító   | Sebesülés az esés következtében lehet.                                                                                                                       |
| Parittya     |    egykezes    | `+2`  |      Z       |  `0`   | `4`  | `+4` |  `2`  |            `70m` |   `10`   |  hajító   | `SFÉ` duplán számít ellene                                                                                                                                   |
