...
Folytatásként a 8 [Tulajdonságod](010_05_01_tulajdonsagok.md) értékét kell meghatároznod `[-5; 5]` intervallumban **Tulajdonságpontok** elosztásával, majd a [Karakteralkotó Pontjaid](010_06_kp.md) (`KP`) kiszámolása következik, amelyekből különböző ismereteket vehetsz majd fel. Figyelj, hogy a [Szekunder KP](010_06_kp.md)-kat csak [Szekunder ismeretekre költheted](010_08_primer_szekunder_ismeretek.md).
...
A [Harcérték Módosítók (HM, CM)](010_07_01_hm_cm.md) felvétele is `KP`-ból történik, ezek az általános harci tapasztalat növekedését hivatottak modellezni. A [Manőver Pontokat](066_02_manover_pontok.md) automatikusan kapod, az elvégzett [Manővereidet](066_00_manoverek.md) könnyítheted meg velük.
...
Jöhetnek a [Származtatott értékek](010_09_00_szarmaztatott_ertekek.md): az [Életerő Pont és Fáradság Pont](010_09_01_ep_kt.md), a már említett [Manőver Pontok](066_02_manover_pontok.md), a [Mágiaellenállás](010_09_04_magiaellenallas.md), a [Méregellenállás](010_09_05_meregellenallas.md) kiszámítása - ezekre nem kell külön pontot költeni.
