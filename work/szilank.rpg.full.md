...
A különböző fém ötvözetek alapanyagai változtathatnak az `SFÉ` értékeken. Csak fém struktúráknál releváns. Amihez viszonyítunk az alaphelyzetben az acél (`+0`).
