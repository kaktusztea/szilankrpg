...
---
---
## File: md/kepzettsegek.primer.misztikus/osszpontositas.md
...
🔒 [Mesterfegyver](mesterfegyver.md): `2.fok` az épp használt fegyverre

🌟 `1db` plusz támadásodra a levonás csak `TÉ:-3`

<br />

### 2. fok

🔒 [Mesterfegyver](mesterfegyver.md): `3.fok` az épp használt fegyverre

🌟 **Hatás**:
- Minden plusz támadásodra a levonás mindig csak `TÉ:-3`
- Kétkezes harcban csak akkor tudod használni, ha mindkét fegyverre megvan a Mesterfegyver `3.fok` követelmény. Ha nincs, akkor csak az `1.fok` érvényesül.
...
Merevvért büntetés Hatásairól a [Vért MGT](../069_03_vert_MGT.md) oldalon olvashatsz.
...
Az apró méret, alacsonyabb Életerőt is jelent, ezért karaktered `ÉP` értéke alaphelyzetben is jelentősen alacsonyabb. Kompenzációként karakteralkotáskor bónusz `KP` javadalmazásban részesülsz.
...
Süket karakter indítása esetén a karakter **hallás** érzékére permanens [Érzékvesztés - teljes](../082_statuszok.md#%EF%B8%8F-%C3%A9rz%C3%A9kveszt%C3%A9s-3-teljes) Státuszt kap. Ezért kompenzációként `1.` tapasztalati szinten bónusz `KP` javadalmazásban részesül.
...
Vak karakter indítása esetén a karakter **látás** érzékére permanens [Érzékvesztés - teljes](../082_statuszok.md#%EF%B8%8F-%C3%A9rz%C3%A9kveszt%C3%A9s-3-teljes) Státuszt kap. Ezért kompenzációként `1.` tapasztalati szinten bónusz `KP` javadalmazásban részesül.
...
Harc és mozgás során a vértek, Pajzsok és a Felszerelés különböző mértékben korlátozhatják a karaktereket. Ennek szimulálására van a **Mozgásgátló Tényező** – röviden **MGT**.

### Vértek, páncélok MGT értéke

- Bővebben: [Harcrendszer: Vért MGT](069_03_vert_MGT.md)
...
A pajzsokra nem vonatkozik az [MGT](069_03_vert_MGT.md) pontrendszer, amelyet vértekre alkalmazunk.
...
→ [Beszorított helyzet (2) Erősen](065_01_03_harci_poziciok.md#beszorított-helyzet-2-erősen) harci helyzet `+` [Sebzés csökkentett](081_hatasok.md#-sebz%C3%A9s-cs%C3%B6kkentett) Hatás
...
❌ VÉ csökkentés: az így végrehajtott támadás **NEM** okoz.
...
### Felforrósodott fém vértek

A fém vértek, ha felforrósodnak, folyamatos sebzést okozhatnak körönként. Ennek mértékéről a szituáció ismeretében a KM dönt.
...
🔆 [MGT hatása a próbára](../069_03_vert_MGT.md): KM dönt a helyzet ismeretében
